...
public class Demo1 extends XdevView {
	...
	private void initUI() {
		...
		this.table.setVisibleColumns("customerId", "companyName", "contactName", "contactTitle");
		this.tabSheet.addStyleName("framed");
		this.label.setValue("companyName");
		this.textField.setTabIndex(1);
		this.label2.setValue("contactName");
		this.textField2.setTabIndex(2);
		this.label3.setValue("contactTitle");
		...
		this.gridLayout2.addComponent(this.label5, 0, 4);
		this.textField5.setWidth(100, Unit.PERCENTAGE);
		this.textField5.setHeight(-1, Unit.PIXELS);
		this.gridLayout2.addComponent(this.textField5, 1, 4);
		...
		this.gridLayout3.addComponent(gridLayout3_vSpacer, 0, 6, 1, 6);
		this.gridLayout3.setRowExpandRatio(6, 1.0F);
		this.gridLayout2.setSizeFull();
		this.tabSheet.addTab(this.gridLayout2, "Tab1", null);
		this.gridLayout3.setSizeFull();
		this.tabSheet.addTab(this.gridLayout3, "Tab2", null);
		...
		this.table.setHeight(200, Unit.PIXELS);
